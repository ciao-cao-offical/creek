 ...
 * @version v 1.0.0
 * @date 2022/5/10 0010
 * @description https://leetcode.cn/problems/cat-and-mouse-ii/solution/mao-he-lao-shu-ii-by-leetcode-solution-e5io/
 * ☆☆☆☆☆ cv
 */
public class CanMouseWin {
    public static void main(String[] args) {
        ...
        System.out.println(new CanMouseWin().canMouseWin(grid, catJump, mouseJump));
    }
