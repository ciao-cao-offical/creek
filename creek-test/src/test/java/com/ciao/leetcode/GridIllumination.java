 ...
 * @version v 1.0.0
 * @date 2022/2/8
 * @description https://leetcode-cn.com/problems/grid-illumination/
 * ★★★★★ cv
 */
public class GridIllumination {
    public static void main(String[] args) {
        System.out.println(Arrays.toString(new GridIllumination().gridIllumination(5, new int[][]{new int[]{0, 0}, new int[]{4, 4}}, new int[][]{new int[]{1, 1}, new int[]{1, 0}})));
    }
